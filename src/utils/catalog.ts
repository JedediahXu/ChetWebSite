export default function (opts) {
	...
	$catalog.addEventListener('scroll', simpleScrollHandler)
	...
	function clickHandler({ target }) {
		...
		if (document.getElementById(datasetId).style.backgroundColor === 'pink') {
			document.getElementById(datasetId).style.backgroundColor = ''
