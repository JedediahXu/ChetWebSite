...
<template>
	<div class="sidebar-top">
		...
		<ul class="menu bg-base-100 w-56 p-2 rounded-box rounded-color">
			...
			<li id="list-comentas" class="menu-list-top" @click="pushJump(4)">
		...
		<div id="player">
			<div class="player-left">
				<iframe frameborder="true" muted="muted" width="240" height="86" src="//music.163.com/outchain/player?type=2&id=362998&auto=0&height=66"></iframe>
			</div>
		...
		<footer class="footer bg-base-200 text-base-content text-bottom">
			<div class="text-bottom-div">
				...
				<p>前端开发日志Vue && TypeScript<br /><a href="https://beian.miit.gov.cn/#/Integrated/index" target="_blank">鲁ICP备20030946号-2</a></p>
			</div>
		</footer>
	</div>
</template>
