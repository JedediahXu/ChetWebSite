...
<template>
  <div class="dropdown dropdown-end">
    <div tabindex="0" @click="select()" class="btn gap-1 normal-case btn-ghost"><svg width="20" height="20"
    ...
    <ul tabindex="0" v-if="selectTheme === false"
...
let selectTheme = ref<boolean>(false)
